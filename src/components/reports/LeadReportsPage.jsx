...
const LeadReportsPage = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState('Lead Reports');
  const [searchTerm, setSearchTerm] = useState('');
  const [reports, setReports] = useState([]);
  const [loading, setLoading] = useState(true);

  // Sample lead reports data matching your image
  const sampleLeadReports = [
    {
      id: 1,
      name: "Leads by Industry",
      description: "Leads by industry",
      folder: "Lead Analysis",
  ...
  useEffect(() => {
    // Simulate API call for lead reports
    const loadLeadReports = () => {
      setLoading(true);
      setTimeout(() => {
        let filteredReports = [...sampleLeadReports];
        ...
        if (folder) {
          ...
          const folderName = folderMap[folder] || 'Lead Reports';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      const filtered = sampleLeadReports.filter(report =>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search lead reports..."
                  value={searchTerm}
      ...
      <div className="p-6">
        ...
        {/* Lead Reports Table Section */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Lead Reports</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Lead Reports found</h3>
              <p className="text-gray-500">
                No lead reports available.
              </p>
            </div>
          ) : (
