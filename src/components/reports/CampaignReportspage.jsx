...
const CampaignReportsPage = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState('Campaign Reports');
  const [searchTerm, setSearchTerm] = useState('');
  const [reports, setReports] = useState([]);
  const [loading, setLoading] = useState(true);

  // Sample campaign reports data
  const sampleCampaignReports = [
    {
      id: 1,
      name: "Campaign Performance",
      description: "Overall performance and ROI of marketing campaigns",
      folder: "Campaign Analysis",
    ...
    {
      id: 3,
      name: "Campaign Response Analysis",
      description: "Analysis of customer responses to campaigns",
      folder: "Response Reports",
    ...
    {
      id: 4,
      name: "Lead Generation by Campaign",
      description: "Leads generated from each marketing campaign",
      folder: "Lead Reports",
    ...
    {
      id: 5,
      name: "Campaign Cost Analysis",
      description: "Cost per lead and overall campaign expenditure",
    ...
    },
    {
      ...
      description: "Performance metrics for social media campaigns",
      folder: "Social Media",
    ...
    },
    {
      ...
      description: "Conversion rates through campaign funnel stages",
      folder: "Conversion Reports",
  ...
  useEffect(() => {
    // Simulate API call for campaign reports
    const loadCampaignReports = () => {
      setLoading(true);
      setTimeout(() => {
        let filteredReports = [...sampleCampaignReports];
        ...
        if (folder) {
          ...
          const folderName = folderMap[folder] || 'Campaign Reports';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      const filtered = sampleCampaignReports.filter(report =>
      ...
      setReports(sampleCampaignReports);
    }
  }, [searchTerm]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search campaign reports..."
                  value={searchTerm}
      ...
      <div className="p-6">
        ...
        {/* Campaign Reports Table Section */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Campaign Reports found</h3>
