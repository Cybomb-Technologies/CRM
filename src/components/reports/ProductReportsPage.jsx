...
const ProductReportsPage = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState('Product Reports');
  const [searchTerm, setSearchTerm] = useState('');
  const [reports, setReports] = useState([]);
  const [loading, setLoading] = useState(true);

  // Sample product reports data matching your image
  const sampleProductReports = [
    {
      id: 1,
      name: "Products by Cases",
      description: "Products and Cases",
    ...
    {
      id: 2,
      name: "Products by Support Termination Date",
      description: "Products ending support this month",
    ...
    },
    {
      ...
      description: "Products based on category",
      folder: "Product Analysis",
  ...
  useEffect(() => {
    // Simulate API call for product reports
    const loadProductReports = () => {
      setLoading(true);
      setTimeout(() => {
        let filteredReports = [...sampleProductReports];
        ...
        if (folder) {
          ...
          const folderName = folderMap[folder] || 'Product Reports';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      const filtered = sampleProductReports.filter(report =>
      ...
      setReports(sampleProductReports);
    }
  }, [searchTerm]);
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search product reports..."
                  value={searchTerm}
      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Product Reports</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Product Reports found</h3>
