...
const VendorReportsPage = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState('Vendor Reports');
  const [searchTerm, setSearchTerm] = useState('');
  const [reports, setReports] = useState([]);
  const [loading, setLoading] = useState(true);

  // Sample vendor reports data
  const sampleVendorReports = [
    {
      id: 1,
      name: "Vendor Performance",
      description: "Vendor performance metrics and ratings",
      folder: "Vendor Management",
    ...
    },
    {
      ...
      description: "Payment history and terms with vendors",
    ...
    {
      id: 3,
      name: "Vendor by Category",
      description: "Vendors categorized by product/service type",
    ...
    {
      id: 4,
      name: "Active Vendor Contracts",
      description: "Currently active contracts and their terms",
      folder: "Contract Management",
    ...
    },
    {
      ...
      description: "Compliance and certification status of vendors",
    ...
    {
      id: 6,
      name: "Vendor Lead Time Analysis",
      description: "Delivery and response times by vendor",
    ...
    {
      id: 7,
      name: "Vendor Cost Comparison",
      description: "Cost analysis and comparison across vendors",
      folder: "Financial Reports",
    ...
    {
      id: 8,
      name: "Vendor Quality Metrics",
      description: "Quality ratings and defect analysis by vendor",
  ...
  useEffect(() => {
    // Simulate API call for vendor reports
    const loadVendorReports = () => {
      setLoading(true);
      setTimeout(() => {
        let filteredReports = [...sampleVendorReports];
        ...
        if (folder) {
          ...
          const folderName = folderMap[folder] || 'Vendor Reports';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      const filtered = sampleVendorReports.filter(report =>
      ...
      setReports(sampleVendorReports);
    }
  }, [searchTerm]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {/* Vendor Reports Table Section */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Vendor Reports</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Vendor Reports found</h3>
