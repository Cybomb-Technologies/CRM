...
const AccountReportsPage = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState('Account and Contact Reports');
  const [searchTerm, setSearchTerm] = useState('');
  const [reports, setReports] = useState([]);
  const [loading, setLoading] = useState(true);

  // Sample account and contact reports data
  const sampleAccountReports = [
    {
      id: 1,
      name: "Accounts by Industry",
      description: "Accounts categorized by industry type",
    ...
    },
    {
      id: 2,
      name: "Key Accounts",
      description: "Accounts with more Deals and higher revenue",
      folder: "Account Reports",
    ...
    },
    {
      ...
      description: "Contact Address details for mailing campaigns",
      folder: "Contact Reports",
  ...
  useEffect(() => {
    // Simulate API call for account reports
    const loadAccountReports = () => {
      setLoading(true);
      setTimeout(() => {
        let filteredReports = [...sampleAccountReports];
        ...
        if (folder) {
          ...
          const folderName = folderMap[folder] || 'Account and Contact Reports';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      const filtered = sampleAccountReports.filter(report =>
      ...
      setReports(sampleAccountReports);
    }
  }, [searchTerm]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search Account and Contact reports..."
                  value={searchTerm}
      ...
      <div className="p-6">
        ...
        {/* Account and Contact Reports Table Section */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Account and Contact Reports</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Account Reports found</h3>
              <p className="text-gray-500">
                No account and contact reports available.
              </p>
            </div>
          ) : (
