// src/components/campaigns/CampaignActivities.jsx
...
const CampaignActivities = ({ campaign }) => {
  ...
  const handleUpdateActivityStatus = (activityId, newStatus) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Track emails, calls, meetings, and tasks related to this campaign</p>
        </div>
              ...
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="flex gap-2">
                  <Select 
                    ...
                    onValueChange={(value) => handleUpdateActivityStatus(activity.id, value)}
                  >
                    <SelectTrigger className="w-32">
                      <SelectValue />
                    </SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setActivityData(prev => ({ ...prev, assignedTo: e.target.value }))}
