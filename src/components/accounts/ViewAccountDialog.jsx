...
import { Building2, Globe, Phone, Mail, MapPin, Users, Calendar, DollarSign } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <strong>Annual Revenue:</strong> {account.annualRevenue ? `$${(account.annualRevenue / 1000000).toFixed(1)}M` : 'Not specified'}
                </div>
                <div>
