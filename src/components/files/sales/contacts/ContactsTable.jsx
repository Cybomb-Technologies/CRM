...
const ContactsTable = ({
  ...
  const handleSelectAll = (checked) => {
    if (checked) {
      onContactSelect(contacts.map((contact) => contact._id || contact.id));
    } else {
      onContactSelect([]);
    }
  };
                ...
                <td className="p-4">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleSelectContact(contactId, checked)
                    }
                  />
                </td>
                ...
                <td className="p-4 text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem
                        onClick={() => onContactView && onContactView(contact)}
                      >
                        <Eye className="w-4 h-4 mr-2" />
                        View
                      </DropdownMenuItem>
                      <DropdownMenuItem
                        onClick={() => onContactEdit && onContactEdit(contact)}
                      >
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          onContactEmail && onContactEmail(contact)
                        }
                      >
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          onContactDelete && onContactDelete(contact)
                        }
