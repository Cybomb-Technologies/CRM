  ...
  const viewOptions = [
    {
      value: "all",
      label: "All Deals",
      description: "View all deals across all stages",
    },
    {
      value: "my-deals",
      label: "My Deals",
    ...
    },
    {
      ...
      description: "Deals worth ₹50L or more",
    },
    {
      value: "closing-this-month",
    ...
    },
    {
      value: "stuck-deals",
      label: "Stuck Deals",
      description: "Deals not updated in 30+ days",
    },
    {
      value: "qualification-stage",
      label: "Qualification Stage",
      description: "Deals in qualification phase",
    },
    {
      value: "proposal-stage",
      label: "Proposal Stage",
      description: "Deals with proposals sent",
    },
    {
