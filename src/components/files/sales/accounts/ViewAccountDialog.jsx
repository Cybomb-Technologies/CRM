...
import { Building2, Globe, Phone, Mail, MapPin, Users, Calendar, IndianRupee } from 'lucide-react';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <strong>Employees:</strong> {account.employees || 'Not specified'}
                </div>
                <div>
                  <strong>Annual Revenue:</strong> {account.annualRevenue ? `₹${(account.annualRevenue / 10000000).toFixed(1)} Cr` : 'Not specified'}
                </div>
                <div>
                  <strong>Account Type:</strong> {account.type || 'Not specified'}
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Address Information */}
          {(account.billingAddress?.street || account.shippingAddress?.street) && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center">
                ...
                {account.billingAddress?.street && (
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>{account.billingAddress.city}, {account.billingAddress.state} {account.billingAddress.zipCode}</div>
                ...
                {account.shippingAddress?.street && (
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>{account.shippingAddress.city}, {account.shippingAddress.state} {account.shippingAddress.zipCode}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t">
            <div className="space-y-2">
              ...
              <div><strong>Last Updated:</strong> {new Date(account.updatedAt).toLocaleString()}</div>
            </div>
          </div>
        </div>
      </DialogContent>
