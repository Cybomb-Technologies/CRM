...
import { Plus, Search, Filter, Download, Zap, ArrowRight } from 'lucide-react';
...
const Quotes = () => {
  ...
  const handleTryCPQ = () => {
    // Navigate to CPQ page or open CPQ modal
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {quotes.map((quote) => (
                    <tr key={quote.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{quote.account}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
